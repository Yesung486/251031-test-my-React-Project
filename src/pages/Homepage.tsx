...
const Homepage: React.FC = () => {
  const [websites, setWebsites] = useState<Website[]>([
    { id: '1', name: '네온 브레이커 게임', description: '집중력 향상을 위한 벽돌깨기 게임 페이지로 이동합니다.', thumbnailUrl: 'images/brick.png', category: '게임', url: '#', path: '/neonbreaker', },
    { id: '2', name: 'AI 가상 피팅', description: 'AI를 사용하여 옷을 가상으로 입어보는 페이지로 이동합니다.', thumbnailUrl: 'images/fiting.jpg', category: '기타', url: '#', path: '/virtual-try-on', },
    { id: '3', name: 'AIVOCA 단어장', description: 'AI와 함께 나만의 영어 단어장을 만들고 학습하는 앱입니다.', thumbnailUrl: 'images/englishword.webp', category: '학습', url: '#', path: '/aivoca', },
    { id: '4', name: '서바이벌게임', description: '서바이벌 게임을 즐길 수 있는 페이지입니다.', thumbnailUrl: 'images/tangtang.webp', category: '게임', url: '#', path: '/survivor-game', },
    { id: '5', name: '다리 만드는 게임', description: '다리 만드는 게임을 즐길 수 있는 페이지입니다.', thumbnailUrl: 'images/rode.jpeg', category: '게임', url: '#', path: '/drawbridgegame', },
    { id: '6', name: '지하철 러너 게임', description: '지하철 러너 게임을 즐길 수 있는 페이지입니다.', thumbnailUrl: 'images/subway.jpg', category: '게임', url: '#', path: '/subway-runner', },
    { id: '7', name: '슬라이스 게임', description: '과일을 슬라이스하는 재미있는 게임 페이지로 이동합니다.', thumbnailUrl: 'images/niga.jpeg', category: '게임', url: '#', path: '/slice-game', },
    { id: '8', name: '네온 스택 게임', description: '네온 블록을 쌓아 올리는 스택 게임 페이지로 이동합니다.', thumbnailUrl: 'images/stack.gif', category: '게임', url: '#', path: '/neon-stack', },
    ...
    { 
      ...
      thumbnailUrl: 'images/desiin.jpg', 
      category: '예술', 
      url: '#', 
    ...
    thumbnailUrl: 'images/Tipo.webp', // 썸네일은 나중에 예쁜걸로 바꾸세요
    category: '예술', 
    url: '#',
